...
{
    /**
     * @Route("/", name="emprunt_index", methods={"GET","POST"})
     */
    public function index(EmpruntRepository $empruntRepository,Request $request): Response
    {
        $emprunt = new Emprunt();
        ...
        return $this->renderForm('emprunt/index.html.twig', [
